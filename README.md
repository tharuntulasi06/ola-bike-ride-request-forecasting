...
```text
 ...
 └──────────────────────────────────┬───────────────────────────────┘
                                    ...
                                    ▼
 ┌──────────────────────────────────────────────────────────────────┐
 │ Step 2: Multi-Step Gradient Boosting Trio Training               │
 │ • XGBoost Regressor (Tweedie/Poisson loss)                       │
 │ • LightGBM Regressor (Leaf-wise fast execution)                  │
 │ • CatBoost Regressor (Ordered target encoding)                   │
...
* **ML Engine**: Python 3.10+, `scikit-learn`, `xgboost`, `lightgbm`, `catboost`, `pandas`, `numpy`, `statsmodels`, `joblib`
